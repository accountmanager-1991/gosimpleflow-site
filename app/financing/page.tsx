    ...
    <>
      ...
      <section className="py-20 max-w-5xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {OPTIONS.map(o => (
            <div key={o.name} className="border border-slate-200 rounded-2xl p-6 hover:border-orange-300 hover:shadow-md transition">
              <span className="inline-block bg-orange-100 text-orange-700 text-xs font-semibold px-2 py-1 rounded uppercase tracking-wider mb-2">{o.best}</span>
              <h2 className="text-2xl font-bold text-slate-900 mb-2">{o.name}</h2>
