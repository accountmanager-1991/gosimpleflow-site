    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#32373c] mb-4">Why homeowners choose Simple Flow</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {ITEMS.map(item => (
            <div key={item.title} className="bg-[#fffdf1] border border-[#f0cc00]/30 rounded-2xl p-8 hover:border-[#f0cc00] hover:shadow-lg transition">
              <div className="text-4xl mb-4">{item.icon}</div>
              <h3 className="text-xl font-bold text-[#32373c] mb-3">{item.title}</h3>
